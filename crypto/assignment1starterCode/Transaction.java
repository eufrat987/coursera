 ...
 *              ----------------
 *
 *   key (prev hash, prev idx)              key (tr hash, output.idx)
 *   \                          \           \
 *   output                       \         |
 *                              (input,      output)
 *
 ...
 *  current tr hash {
 *               \
 *      input - (prevhash, index)
 *                          \
 *                          output (value, address)
 * }
 *
 *
 * hash, index -> output <br> <br>
 *
 *
 * hash                    <br>
 * list of inputs           <br>
...
public class Transaction {
    ...
    private byte[] hash; // UTXO key
    private ArrayList<Input> inputs;
    private ArrayList<Output> outputs;

    /**
     * trans id 73              <br>
     * consumed coins 71(2) ... <br>
     */
    public class Input {
        /** hash of the Transaction whose output is being used */
        public byte[] prevTxHash; // ?
        /** used output's index in the previous transaction */
        public int outputIndex; // UTXO key
    ...
    /**
     * input (without tx hash) and all outputs
     * @param index
     * @return
     */
    ...
    /**
     * used in finalize()
     * to create hash( inputs, outputs ) of this trancsaction <br>
     *
     * @return
     */
